...
typedef Element QueueEntry; /*this data type of the entries of the queue and can be defined as what ever you want*/
...
void TraverseQueue(Queue *, void (*)(Element)); /*this function takes the pointer of the queue and the pointer of the functoin that will visit the entries*/
