...
typedef Element ListEntry; /*this data type of the entries of the list and can be defined as what ever you want*/
...
void TraverseList(List *, void (*)(Element)); /*this function takes the pointer of the list and the pointer of the functoin that will visit the entries*/
